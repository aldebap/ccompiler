...
static void testCase_success()
{
    ...
    /*  expected parameters for the regcomp */
    expect_any(__wrap_regcomp, _regex);
    expect_string(__wrap_regcomp, _pattern, "[.]c$");
    expect_value(__wrap_regcomp, _cflags, REG_EXTENDED);
    will_return(__wrap_regcomp, 0);
...
/*
    test case 003 - initialize the sourceFileCompiler with fail in the second regex
*/
...
int runInitializeSourceFileCompilerTests()
{
    const struct CMUnitTest testCases[] = {
        ...
        {"test case 003 - initialize the sourceFileCompiler with fail in the second regex", testCase_failInSecondRegex, NULL, NULL},
    };
