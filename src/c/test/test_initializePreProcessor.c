...
static void testCase_success()
{
    ...
    /*  expected parameters for pragma */
    expect_any(__wrap_regcomp, _regex);
    expect_string(__wrap_regcomp, _pattern, "^[ \t]*#[ \t]*pragma[ \t]+(.*)[ \t]*\n$");
    expect_value(__wrap_regcomp, _cflags, REG_EXTENDED);
    will_return(__wrap_regcomp, 0);
...
/*
    test case 015 - initialize the preprocessor with fail in the fourteenth regex
*/

static void testCase_failInFoureenthRegex()
{
    /*  expected parameters for comment begin */
    expect_any(__wrap_regcomp, _regex);
    expect_string(__wrap_regcomp, _pattern, "(/[*])$");
...
/*
    test case 016 - initialize the preprocessor with fail in the macroList initialization
*/
...
/*
    test case 017 - initialize the preprocessor with fail in the copy macro list
*/
...
int runInitializePreProcessorTests()
{
    const struct CMUnitTest testCases[] = {
        ...
        {"test case 015 - initialize the preprocessor with fail in the fourteenth regex", testCase_failInFoureenthRegex, NULL, NULL},
        {"test case 016 - initialize the preprocessor with fail in the macroList initialization", testCase_failInMacroListInitialization, NULL, NULL},
        {"test case 017 - initialize the preprocessor with fail in the copy macro list", testCase_failInCopyMacroList, NULL, NULL},
    };
